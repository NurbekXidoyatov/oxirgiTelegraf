...
export default function Modal({
  ...
  }, [showAcceptbtn, request, singleId]);
          ...
          >
            ...
            {message?.messageStatus === "SENDING" ||
              ...
              {message?.messageStatus === "ACCEPTED" ? (
                <button class="action bg_color_goBack" onClick={() => history.push(`/kiruvchixabarlar/forwardMessage/${message.id}`)}>
...
{/* <button class="action bg_color_btn_accept">Qabul qilish</button>
          <button class="action bg_color_btn_cancell">Rad etish</button> */}